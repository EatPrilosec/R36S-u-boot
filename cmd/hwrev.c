...
int do_hwrev(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
	...
	if (check_range(146, 186, hwrev_adc)) {
		...
		run_command("if env exists hwrev; then; echo \"skip mmc init\"; else; setenv devnum 1; echo \"pancho init\"; echo \"rescan mmc...\"; mmc rescan; echo \"list mmc...\"; mmc list; echo \"info mmc...\"; mmc info; echo \"###### before load ######\" ;printenv PanChoEnvSize WipePanChoEnv LoadPanChoEnv SavePanChoEnv PanChoEnvLoaded; setenv -f PanChoEnvLoaded false; run LoadPanChoEnv; echo \"###### after load ######\"; printenv PanChoEnvSize WipePanChoEnv LoadPanChoEnv SavePanChoEnv PanChoEnvLoaded; fi", 0);
