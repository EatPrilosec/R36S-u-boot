...
int init_kernel_dtb(void)
{
	...
	if (ret < 0) {
		...
		if (ret != CMD_RET_SUCCESS) {
			...
			run_command("setenv dtbfile rg351mp-kernel.dtb ; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 6/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 7/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 8/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 9/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 10/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel custom/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; fi; setenv dtbfile rg351mp-uboot.dtb; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 6/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 7/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 8/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 9/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 10/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel custom/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; fi; setenv dtbfile r3xs-uboot.dtb; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 6/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 7/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 8/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 9/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 10/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel custom/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; fi; setenv dtbfile R3XS-uboot.dtb; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 6/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 7/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 8/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 9/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 10/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel custom/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; fi; setenv dtbfile r36s-uboot.dtb; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 6/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 7/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 8/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 9/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 10/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel custom/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; fi; setenv dtbfile R36S-uboot.dtb; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 6/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 7/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 8/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 9/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 10/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel custom/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; fi", 0);
