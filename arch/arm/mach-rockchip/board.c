...
int init_kernel_dtb(void)
{
	...
	if (ret < 0) {
		...
		if (ret != CMD_RET_SUCCESS) {
			...
			run_command("setenv dtbfile rg351mp-kernel.dtb ; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 1/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 2/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 3/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 4/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 5/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel RGB20S/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel Custom/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; elif setenv dtbfile rg351mp-uboot.dtb; then ; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 1/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 2/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 3/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 4/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 5/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel RGB20S/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel Custom/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; elif setenv dtbfile r36s-uboot.dtb; then; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 1/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 2/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 3/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 4/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 5/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel RGB20S/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel Custom/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; elif setenv dtbfile R36S-uboot.dtb; then; if load mmc 1:1 ${fdt_addr_r} \"${dtbfile}\"; then; echo \"found ${dtbfile} on root\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/${dtbfile}\"; then; echo \"found ScreenFiles/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 0/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 0/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 1/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 1/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 2/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 2/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 3/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 3/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 4/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 4/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel 5/${dtbfile}\"; then; echo \"found ScreenFiles/Panel 5/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel RGB20S/${dtbfile}\"; then; echo \"found ScreenFiles/Panel RGB20S/${dtbfile}\"; elif load mmc 1:1 ${fdt_addr_r} \"ScreenFiles/Panel Custom/${dtbfile}\"; then; echo \"found ScreenFiles/Panel Custom/${dtbfile}\"; fi; fi; fi; fi", 0);
